...
In some project there may be a `CONVENTIONS.md` file.
If this is the case, ALWAYS read this before writing any code and comply with the rules described in this document.
